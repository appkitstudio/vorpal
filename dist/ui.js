...
var UI = (function (_EventEmitter) {
  ...
  function UI() {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (UI.__proto__ || Object.getPrototypeOf(UI)).call(this)
    );
  ...
  _createClass(UI, [
    {
      ...
      value: function sigint(fn) {
        if (_.isFunction(fn)) {
          ...
          throw new Error(
            "vorpal.ui.sigint must be passed in a valid function."
          );
        }
        return this;
      },
    ...
    },
    {
      ...
      value: function setDelimiter(str) {
        ...
        inquirer.prompt.prompts.input.prototype.getQuestion = function () {
          ...
          if (
            (this.opt.default || this.opt.default === false) &&
    ...
    },
    {
      ...
      value: function _keypressHandler(e, prompt) {
        ...
        var addition =
          prompt.status === "answered" ? chalk.cyan(prompt.answer) : line;
        message += addition;
      ...
      value: function log() {
        ...
        if (this.midPrompt()) {
          ...
          if (typeof data !== "undefined" && data !== false) {
            ...
            console.log(
              "Log got back 'false' as data. This shouldn't happen.",
              data
            );
          }
        } else {
